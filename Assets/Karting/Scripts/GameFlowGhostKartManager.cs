...
public class GameFlowGhostKartManager : MonoBehaviour
{
    [Header("Parameters")]
    ...
    void Start()
    {
        if (autoFindKarts)
        {
            ...
            DebugUtility.HandleErrorIfNullFindObject<ArcadeKart, GameFlowGhostKartManager>(playerKart, this);
        }

        m_ObjectiveManager = FindObjectOfType<ObjectiveManager>();
        DebugUtility.HandleErrorIfNullFindObject<ObjectiveManager, GameFlowGhostKartManager>(m_ObjectiveManager, this);

        m_TimeManager = FindObjectOfType<TimeManager>();
        DebugUtility.HandleErrorIfNullFindObject<TimeManager, GameFlowGhostKartManager>(m_TimeManager, this);
